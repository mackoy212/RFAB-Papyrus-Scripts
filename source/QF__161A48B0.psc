...
Scriptname QF__161A48B0 Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY StrangeDevice
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_StrangeDevice Auto
;END ALIAS PROPERTY
...
; если вдруг застряла за ступеньками
Actor Katria = Alias_Katria.GetActorReference()
if (Katria.GetDistance(BAKatriaMarker01) < Katria.GetDistance(BAKatriaMarker02))
	Katria.MoveTo(BAKatriaMarker02)
endif
;END CODE
EndFunction
;END FRAGMENT
...
if Game.GetPlayer().GetItemCount(Alias_QuestItem.GetReference()) > 0
	SetObjectiveCompleted(40)
endif
;END CODE
EndFunction
...
WEAPON Property Zephyr  Auto  

ObjectReference Property BAKatriaMarker01  Auto  

ObjectReference Property BAKatriaMarker02  Auto  
