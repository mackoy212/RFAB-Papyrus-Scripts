...
Function Fragment_4()
;BEGIN CODE
Game.GetPlayer().AddSpell(ImperialCompleteBonus, false)
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_2()
;BEGIN CODE
Game.GetPlayer().AddSpell(StormcloaksCompleteBonus, false)
;END CODE
EndFunction
;END FRAGMENT
...
Spell Property ImperialCompleteBonus Auto

Spell Property StormcloaksCompleteBonus Auto
