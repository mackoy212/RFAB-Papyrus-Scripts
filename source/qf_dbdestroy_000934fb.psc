...
Alias_FestusKrexAlias.GetActorRef().AddItem(RFAB_Ring_NightweaversBand, 1) ; Edited by RFAB
Alias_FestusKrexAlias.GetActorRef().EquipItem(RFAB_Ring_NightweaversBand) ; Edited by RFAB
...
Actor Property Gvilierm  Auto  

Spell Property CompleteBonus Auto

Armor Property RFAB_Ring_NightweaversBand Auto
