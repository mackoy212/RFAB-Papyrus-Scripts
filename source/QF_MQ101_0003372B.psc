...
; imagespace modifier
Game.FadeOutGame(False, true, 16.0, 20.0)
...
;END AUTOCAST
;BEGIN CODE
RFAB_BA_StartCell.Reset()

Game.GetPlayer().RemoveAllItems()
Game.GetPlayer().EquipItem(ClothesPrisoner, abSilent = true)
Game.GetPlayer().EquipItem(ClothesPrisonerShoes, abSilent = true)

Game.GetPlayer().Moveto(RFAB_BA_StartMarker)
utility.wait(0.3)
...
; stop cart sounds
;RFAB_PapyrusFunctions.StopSound(kmyquest.CartSoundInstanceID)
Sound.SetInstanceVolume(kmyquest.CartSoundInstanceID, 0.2)
...
kmyquest.RegisterForAnimationEvent(Game.GetPlayer(), "Decapitate")
Utility.Wait(1)
ToBeContinued.Play(Game.GetPlayer() as ObjectReference)
Utility.Wait(10.9)
UI.OpenCustomMenu("JojoReference", 0)
Utility.Wait(0.35)
JojoISM.ApplyCrossFade(0.1)
Utility.Wait(0.1)
RFAB_PapyrusFunctions.SetGlobalTimeMultiplier(0)
Utility.Wait(2.9)
game.FadeOutGame(true, true, 0, 3.2)
utility.Wait(2.65)
Game.PlayBink("RFAB_BA_Ending.bik", false,true,true,false)
Game.QuitToMainMenu()
;Debug.Notification("Frag 288")
;The Dragonborn Dies code ends here
...
Cell Property RFAB_BA_StartCell  Auto  

ObjectReference Property RFAB_BA_StartMarker  Auto  

ImageSpaceModifier Property Darkness  Auto  

SPELL Property StopTime  Auto  

Sound Property ToBeContinued  Auto  

ImageSpaceModifier Property JojoISM  Auto  
