...
;         debug.Trace(self + ": MIRAAK STEALS DRAGON SOUL")
        ...
        selfActor.RestoreActorValue("health", 99999);UDBPStartingHealth) ;UDBP 2.0.7 - Changed this because 1000 is not enough to guarantee he fully restores as intended.
