...
Game.GetPlayer().AddSpell(CompleteBonusSap, false)
...
Game.GetPlayer().AddSpell(CompleteBonusSapling, false)
...
Spell Property CompleteBonusSap Auto

Spell Property CompleteBonusSapling Auto
