...
Function MenugeneratorFloat_PreLoad(string sFilename)
	XPConfig.MenugeneratorFloat_PreLoad(MagicEffectMagnitudeBase.Length, EDID, MagicEffectMagnitudeBase, sFilename)
		int i = 0
		int ie = SXPMagicEffect.Length
		While i < ie
			int iBase = PossibleMagicEffectsIndex[i]
