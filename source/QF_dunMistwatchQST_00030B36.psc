...
Alias_Christer.GetActorRef().SetAV("Aggression",3)
Alias_Christer.GetActorRef().SetAV("Confidence",3)
Alias_Christer.GetActorRef().StartCombat(Game.GetPlayer())
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
if (Alias_Fjola.GetActorRef().IsDead())
    SetObjectiveCompleted(75,1)
    SetStage(100)
else
