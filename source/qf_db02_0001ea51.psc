...
Alias_Astrid.GetActorReference().AddToFaction(DarkBrotherhoodFaction) ;RFAB Edit
;END CODE
EndFunction
;END FRAGMENT
...
;END AUTOCAST
;BEGIN CODE
Alias_Astrid.GetActorReference().RemoveFromFaction(DarkBrotherhoodFaction) ;RFAB Edit
