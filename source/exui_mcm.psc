...
Bool Property bHideLegendaryPrompts = true Auto Hidden
Bool Property bShowAttributeModifiers = true Auto Hidden
Bool Property bShowSkillModifiers = true Auto Hidden
