...
Game.GetPlayer().AddItem(ArmorDBCuirass2,1)
Game.GetPlayer().AddItem(ArmorDBBoots2,1)
Game.GetPlayer().AddItem(ArmorDBGauntlets2,1)
Game.GetPlayer().AddItem(ArmorDBHelmet2,1)
;END CODE
EndFunction
;END FRAGMENT
...
Armor Property ArmorDBCuirass2  Auto  

Armor Property ArmorDBBoots  Auto  

Armor Property ArmorDBBoots2  Auto  

Armor Property ArmorDBGauntlets  Auto  

Armor Property ArmorDBGauntlets2  Auto  

Armor Property ArmorDBHelmet  Auto  

Armor Property ArmorDBHelmet2  Auto  
