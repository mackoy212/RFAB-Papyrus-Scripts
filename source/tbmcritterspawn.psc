Scriptname tbmCritterSpawn extends ObjectReference  

import tbmCritterBase
import Utility
...
bool bLooping
bool bPrintDebug = true			; should usually be set to false.
int recursions
...
Function SpawnCritterAtRef(ObjectReference arSpawnRef)
	...
	tbmCritterBase thecritter = critterRef as tbmCritterBase
