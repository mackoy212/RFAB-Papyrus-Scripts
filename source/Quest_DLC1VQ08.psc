...
Scriptname Quest_DLC1VQ08 Extends Quest Hidden
...
if DLC1PlayingVampireLine.GetValueInt() == 1
	Game.GetPlayer().AddSpell(CompleteBonusVolkihar, false)
else
	Game.GetPlayer().AddSpell(CompleteBonusDawnguard, false)
endif
...
Spell Property CompleteBonusVolkihar Auto

Spell Property CompleteBonusDawnguard Auto
