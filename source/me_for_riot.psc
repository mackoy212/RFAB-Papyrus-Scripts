Scriptname ME_For_Riot extends ActiveMagicEffect  
...
MiscObject Property Misc_to_remove  Auto  
MiscObject Property Misc_to_add  Auto  
Scroll Property PotemaScroll Auto  
;======================================================================================;
;  VARIABLES   /
;=============/
actor CasterActor
...
Event OnEffectFinish(Actor Target, Actor Caster)
	...
	if victim
		...
		if DeadAlready == False
			if Caster.GetItemCount(Misc_to_remove)>= 1
				Caster.RemoveItem(Misc_to_remove, (Caster.GetItemCount(Misc_to_remove)))
				Caster.AddItem(Misc_to_add,1, true)
				Caster.AddItem(PotemaScroll,1, true)
