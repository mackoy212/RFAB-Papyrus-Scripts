...
Sound Property MovingSound  Auto  
...
;		Debug.Notification("NPC Decapitation Event")
...
;		HelgenCrowdWallaMarker2.Enable()
	...
	EndIf
;	The following code for The Dragonborn Dies
;	Detect if player is on block and set up an animation event for decapitation
	if (akSource== Game.GetPlayer()) && (asEventName == "Decapitate")
; 		Debug.Notification("Player Decapitation Event")
;		Game.ForceThirdPerson()
;		Utility.Wait(0.1)
;		Game.GetPlayer().Kill()
		UnregisterForAnimationEvent(Game.GetPlayer(), "Decapitate")
	EndIf
