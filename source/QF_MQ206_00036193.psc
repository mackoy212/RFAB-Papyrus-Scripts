...
Gormlaith.GetActorBase().SetEssential(false)
; make Gormlaith weak
Gormlaith.SetActorValue("health", 1)
Alias_AncientAlduin.GetActorRef().PlayIdleWithTarget(KillMoveDragonBiteGrapple, Gormlaith) ; Edited by RFAB
...
Idle Property KillMoveDragonBiteGrapple Auto